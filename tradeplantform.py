...
def decode_call_getTraceInfo(data, print_out=False):
    ...
    if print_out:
        ...
        for each_info in dic:
            print('信息{} 操作者地址:{}  拥有者信息:{} 拥有者地址{} 存放仓库id{} 货品id{} 货品重量{} 货品数量{} 质检日期{} 上链时间{} 仓单状态:{} 其他信息{}'.format(each_info, dic[each_info]['owner_address'], dic[each_info]['owner_id'],
...
try:
    ...
    contract_address = '0xab7b84e8dfb08e225f5f4b93c4621af8bf1139e7'
    result = client.call(contract_address, data_parser.contract_abi, 'getTraceInfo', [11])
    decode_call_getTraceInfo(result, True)
    # print(result)
